...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/vulkan-loader-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/vulkan-loader-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add libvulkan-loader
# for installing globally
pixi global install libvulkan-loader
```
...
It is possible to list all of the versions of `libvulkan-loader` available on your platform:
...
```
pixi search libvulkan-loader --channel conda-forge
```
